...
class DataSource {
    ...
    private constructor() {
        ...
        lessonsArrayList.add(Lesson(3,"Variables and conditionals", "7 min", "A variable is a “named storage” for data. We can use variables to store goodies, visitors, and other data. To create a variable in JavaScript, use the let keyword. Sometimes, we need to perform different actions based on different conditions. To do that, we can use the if statement and the conditional operator ?, that’s also called a “question mark” operator.",true,"https://www.youtube.com/watch?v=IsG4Xd6LlsM", ""))
